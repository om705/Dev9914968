...
# API Configuration
API_ID = int(os.environ.get("API_ID", "29264478"))
API_HASH = os.environ.get("API_HASH", "9aed4788fce88cb77283abaf0685f469")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8710282804:AAFVob9JirpV6WvH9kfZASdZfoUtS1hnXPQ")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "5475199171"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "5475199171").split()]  # Default to owner ID
